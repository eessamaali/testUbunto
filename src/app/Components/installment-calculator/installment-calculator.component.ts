...
calcInstallment(){
  this.installmentService.calculateInstallments(Number(this.gross),Number(this.numberOfInstallment))
  .subscribe(
    res=>{
...
onCalc(gross:any,num:any){
  this.installmentService.$subject.subscribe((val:Installment)=>{
    this.result= val;
  }) 
  this.installmentService.calcInstallment(gross,num, this.result);
}
